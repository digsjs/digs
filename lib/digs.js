  ...
  _detect() {
    return Promise.bind(this)
      ...
      .each(function(plugin) {
        return this.use(plugin, this._opts.plugins[plugin.metadata.name]);
      })
      .catch(function(err) {
  ...
  start() {
    ...
    return (this._ready = Promise.each(tasks, function(task) {
      ...
      .then(function(resolved) {
        ...
        this.publish = this._client.publish.bind(this._client);
        this.subscribe = this._client.subscribe.bind(this._client);
  ...
  loadPlugins(plugins) {
    ...
    return Plugins.load(this, this._graph, plugins)
      ...
      .each(function(pluginData) {
        ...
        this[pluginName] = pluginData.instance;
